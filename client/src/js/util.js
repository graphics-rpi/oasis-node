...
//   var f = num / 0.3048; //meters to feet
//   var t = f * 0.0254; //feet to table units
...
function updateSamWall(samWall, color) {
  ...
  if (color == 'green') {
    samWall.subject.attr({
      src: '../images/samWall_5ft.png'
    });

  } else if (color == 'blue') {
    samWall.subject.attr({
      src: '../images/samWall_8ft.png'
    });


  } else if (color == 'red') {
    samWall.subject.attr({
      src: '../images/samWall_10ft.png'
    });

  } else if (color == 'yellow') {
    samWall.subject.attr({
      src: '../images/samWindow.png'
    });
...
function positionNorthSouth(table, ftNorth, compass_label_n, compass_label_s) {
  ...
  compass_label_n.attr({
    x: text_x_n,
    y: text_y_n
  });
  compass_label_s.attr({
    x: text_x_s,
    y: text_y_s
  });
